...
require 'thomas_utils/enum/concerns/indexing'
require 'thomas_utils/enum/limiter'
require 'thomas_utils/enum/filter'
require 'thomas_utils/enum/combiner'
require 'thomas_utils/enum/make_unique'
require 'thomas_utils/enum/mapping'
...
require 'thomas_utils/executor_collection'
